...
(cl:defmethod cl:initialize-instance :after ((m <FRClientGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FRClientGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audio-msg:<FRClientGoal> is deprecated: use audio-msg:FRClientGoal instead.")))

(cl:ensure-generic-function 'order_id-val :lambda-list '(m))
(cl:defmethod order_id-val ((m <FRClientGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader audio-msg:order_id-val is deprecated.  Use audio-msg:order_id instead.")
  (order_id m))

(cl:ensure-generic-function 'order_argument-val :lambda-list '(m))
(cl:defmethod order_argument-val ((m <FRClientGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader audio-msg:order_argument-val is deprecated.  Use audio-msg:order_argument instead.")
  (order_argument m))
