...
class GridPatchCIFAR10(dense_design_matrix.DenseDesignMatrix):
    """
    .. todo::

        This is the same as the CIFAR10 class defined in pylearn2. However there are some modifications so that this will work with a 256->512 DAE. 

	The image shapes have been changed from (32,32,3)(Dim=3072) to (16,16,1) and the dataset has had (16,16) grid patches extracted in 5 stride length steps per sample. 
    """
    ...
    def get_test_set(self):
        ...
        .. todo::
            ...
            WRITEME
        """
        return GridPatchCIFAR10(which_set='test', center=self.center, rescale=self.rescale, gcn=self.gcn,
